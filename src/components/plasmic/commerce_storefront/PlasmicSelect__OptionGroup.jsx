...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 9lCt5QH2iekkbH/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: ZLEaM8OMizRIoj/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__nXrF7)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__y59Z9)}
              />
            </React.Fragment>
          ),
