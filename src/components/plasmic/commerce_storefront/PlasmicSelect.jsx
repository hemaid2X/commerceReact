...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: gzGOJTFxp5HBUD/component
import Select__Option from "../../Select__Option"; // plasmic-import: joNvp_cTXxoJpD/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: 9lCt5QH2iekkbH/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: ZLEaM8OMizRIoj/css
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: 7oK-PzrkvH5GV0/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: K3ZivCP0QCN9su/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__rDcmP)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option___2IyQc)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
