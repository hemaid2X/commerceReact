...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 8Gj1GZbvcl1-2/css
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: xKWDGJzCx6LSaV/icon
  ...
  return (
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolors_black_rounded_size_large_showEndIcon]:
          ...
          [sty.rootrounded_size_large]:
            hasVariant($state, "rounded", "rounded") &&
            hasVariant($state, "size", "large"),
          [sty.rootrounded_size_large_showEndIcon]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "size", "large") &&
            hasVariant($state, "rounded", "rounded"),
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__iZDqc, {
            [sty.freeBoxcolors_white__iZDqc0Da1L]: hasVariant(
              $state,
              "colors",
              "white"
            ),

            [sty.freeBoxcolors_white_showStartIcon__iZDqc0Da1LZG63O]:
              hasVariant($state, "colors", "white") &&
              hasVariant($state, "showStartIcon", "showStartIcon"),
            [sty.freeBoxiconOnly__iZDqckeMpP]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),

            [sty.freeBoxshowEndIcon__iZDqcogINu]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),

            [sty.freeBoxshowStartIcon__iZDqczG63O]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),

            [sty.freeBoxsize_large__iZDqcX2VsT]: hasVariant(
              $state,
              "size",
              "large"
            ),

            [sty.freeBoxsize_small__iZDqc9RHjA]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg___3K9Pn)}
                    role={"img"}
                  />
                ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__gj251, {
            [sty.freeBoxshowEndIcon__gj251OgINu]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),

            [sty.freeBoxsize_small__gj2519RHjA]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__oMdWm)}
                    role={"img"}
                  />
                ),
                ...
                className: classNames(sty.slotTargetEndIcon, {
                  ...
                  [sty.slotTargetEndIconcolors_black_rounded_size_large_showEndIcon]:
                    hasVariant($state, "showEndIcon", "showEndIcon") &&
                    hasVariant($state, "colors", "black") &&
                    hasVariant($state, "size", "large") &&
                    hasVariant($state, "rounded", "rounded"),
